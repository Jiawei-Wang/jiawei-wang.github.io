  ...
  return (
    <div className="pages">
      ...
      <div className="Section">
        ...
        <a href="https://www.youtube.com/watch?v=dQw4w9WgXcQ/" target="_blank" rel="noopener" className="ProjectWrapper">
          <img alt="The Deep Sea" src={underConstruction} className="ProjectThumbnail" />
      ...
      <div className="Section">
        ...
        <div className="GetInTouch">
          <a target="_blank" rel="noopener" href="https://www.linkedin.com/in/hire-jiawei-wang/" className="ButtonLink linkedin">
            <img alt="LinkedIn Icon" src={linkedinIcon} className="ButtonIcon" /> LinkedIn
          </a>
          <a target="_blank" rel="noopener" href="https://github.com/Jiawei-Wang/jiawei-wang.github.io/issues/new" className="ButtonLink issue">
            <img alt="Issue Icon" src={githubIssueIcon} className="ButtonIcon" /> Github Issue
          </a>
        </div>
      </div>
    </div>
